...
function setup() {
  ...
  b.position(50, 1270);
  let c = createA('https://fmipa.um.ac.id/wp-content/uploads/Prosiding2015/Teori-Komputasi/Fisika2015_11-Teori-Widjianto.pdf', 'https://fmipa.um.ac.id/wp-content/uploads/');
  c.position(900, 860);
...
function draw() {
  ...
  fill('black');
  textSize (12);
  text("*Klik/Salin link/Klik lalu drag pada tempat URL", 900, 890);
  text("*Klik/Salin link/Klik lalu drag pada tempat URL", 900, 930);
  //Footer
  textSize (18);
  fill('white');
